        ...
        <div className="mb-8">
          ...
          <div className="sm:flex flex-none justify-center items-center gap-2 mt-3">
            ...
            <p className="text-gray-50 text-base">
              Hello,there.I am Sneko. I can write a little program. I am more
              interested in the backend. What else? I like cats, but I don't
              have one, because I'm a cat myself.
            </p>
          </div>
        </div>
      </div>
