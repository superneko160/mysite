  ...
  return (
    <div className="max-w-full my-2">
      <div className="bg-stone-300 dark:bg-zinc-800 text-gray-600 dark:text-amber-100 dark:border dark:border-amber-100/25 rounded p-4 flex flex-col justify-between leading-normal">
        <div className="mb-2">
          <h2 className="font-bold text-xl mb-2">Skill</h2>
          <div className="mt-5">
            <h3 className="text-xl mb-1">Programming Language</h3>
            <img
          ...
          <div className="mt-4">
            <h3 className="text-xl mb-1">Library and Framework</h3>
            <img
          ...
          <div className="mt-4">
            <h3 className="text-xl mb-1">Database</h3>
            <img
